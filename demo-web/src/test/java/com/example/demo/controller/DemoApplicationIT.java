...
class DemoApplicationIT {
    ...
    void testCustomerHello() {
        ResponseEntity<Customer> entity =
                restTemplate.getForEntity("http://localhost:8080/customer/hello", Customer.class);
    ...
    void testCustomerSave() {
        ...
        ResponseEntity<Void> entity =
                restTemplate.postForEntity("http://localhost:8080/customer/save", customer, Void.class);
